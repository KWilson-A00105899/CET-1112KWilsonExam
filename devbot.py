...
if choice == "n":
    accessTokenInput = input("Please enter your Webex token: ")
    accessToken = "Bearer " + accessTokenInput
else:
	accessToken = "Bearer YzFjOWMzZWUtYmZkYS00ZjQwLTg1YzItN2FmMDJlN2MxN2M0MTkwNjk3ODctMTlm_PC75_f1a9c66d-3eff-454d-9c51-a4e0afcd770b"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "TYZjPaRRj9vNocFNLYwieGrHTdsnWOWB"
                               }
...
# 9. Provide the URL to the Sunrise/Sunset API.
        r = requests.get("https://api.sunrisesunset.io/json", 
